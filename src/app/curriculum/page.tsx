    ...
    <div className="max-w-7xl mx-auto p-6 lg:p-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          >
            <Sparkles className="w-4 h-4 mr-2" /> Curate with AI
          </Button>
      ...
      {courses.length === 0 ? (
        <div className="text-center py-20 px-4 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800">
          ...
          <p className="text-slate-500 dark:text-slate-400 max-w-md mx-auto mb-8">
            Get started by curating a complete course with AI in seconds, or create one manually with custom modules and study topics.
          </p>
