...
import { CommunityResourcePayload, downloadJsonFile } from '@/lib/community';
import { ShieldCheck, Copy, Check, Download, Star, Globe, AlertCircle, ExternalLink } from 'lucide-react';
    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Share with Community">
      <div className="flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <pre className="p-3 bg-slate-900 text-slate-200 rounded-xl text-[11px] font-mono overflow-x-auto max-h-[160px] custom-scrollbar border border-slate-800">
        ...
        <div className="flex flex-col sm:flex-row gap-2.5 pt-2 border-t border-slate-200 dark:border-slate-800">
          <button
            onClick={handleCopy}
            className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 rounded-xl text-sm font-medium transition-colors border border-slate-200 dark:border-slate-700"
          >
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-sm font-medium transition-colors shadow-sm"
          >
